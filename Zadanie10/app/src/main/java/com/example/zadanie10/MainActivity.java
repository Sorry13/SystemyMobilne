...
public class MainActivity extends AppCompatActivity {
    ...
    public static String EXTRA_TITLE_KEY = "Title";
    public static String EXTRA_AUTHOR_KEY = "Author";
    public static String EXTRA_IMAGE_KEY= "Image";
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            ...
            intent.putExtra(EXTRA_TITLE_KEY, bookTitleTextView.getText());
            intent.putExtra(EXTRA_AUTHOR_KEY, bookAuthorTextView.getText());
            intent.putExtra(EXTRA_IMAGE_KEY, book.getCover());
