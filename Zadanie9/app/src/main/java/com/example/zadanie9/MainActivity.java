...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == NEW_BOOK_ACTIVITY_REQUEST_CODE && resultCode == RESULT_OK) {
            ...
            Book editedBook = bookViewModel.findAll().getValue().get(Integer.parseInt(data.getStringExtra(EditBookActivity.EXTRA_BOOK_KEY)));
    ...
    private class BookHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener  {
        ...
        public void onClick(View v) {
            ...
            int bookId = bookViewModel.findAll().getValue().indexOf(book);
            String bookTitle = bookViewModel.findAll().getValue().get(bookId).getTitle();
            String bookAuthor = bookViewModel.findAll().getValue().get(bookId).getAuthor();
            intent.putExtra(EditBookActivity.EXTRA_BOOK_KEY, String.valueOf(bookId));
            intent.putExtra(EditBookActivity.EXTRA_EDIT_BOOK_TITLE, bookTitle);
            intent.putExtra(EditBookActivity.EXTRA_EDIT_BOOK_AUTHOR, bookAuthor);
