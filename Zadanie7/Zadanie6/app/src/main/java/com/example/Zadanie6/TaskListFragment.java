...
public class TaskListFragment extends Fragment {
    ...
    protected static final String KEY_EXTRA_TASK_ID = "com.example.zadanie6.TaskListFragment.task_id";
    protected static final String KEY_CURRENT_VISIBILITY = "Current_Visibility";
